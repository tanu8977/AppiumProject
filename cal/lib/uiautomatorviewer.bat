...
call "%java_exe%" "-Djava.ext.dirs=%javaextdirs%" "-Dcom.android.uiautomator.bindir=C:\Users\tanuj.000\android-sdk_r24.4.1-windows\android-sdk-windows\tools\bin" -jar %jarpath% %*
